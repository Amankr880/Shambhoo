...
class VendorController extends Controller
{
    ...
    public function getVendor(Request $request)
    {
        ...
        try {
            ...
            $product[0]["product0"] = $inc_picture[0];
            $product[0]["product1"] = $inc_picture[1];
            $product[0]["product2"] = $inc_picture[2];
            $product[0]["product3"] = $inc_picture[3];
         ...
         $response = response()->json(['error'=>'abcd'],200);
        }
        }
        else
        {
