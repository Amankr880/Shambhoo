...
class VendorController extends Controller
{
    ...
    public function getVendor(Request $request)
    {
        ...
        $vendor = Vendor::where('user_id','=',$request->id)->join('plan_subscriptions','vendors.id','=','plan_subscriptions.vendor_id')->select('vendors.*','plan_subscriptions.purchase_date',DB::raw("CONCAT('storage/assets/img/logo/',logo_image) AS logo_image,CONCAT('storage/assets/img/header/',header_image) AS header_image"))->get();
        //return $vendor;
